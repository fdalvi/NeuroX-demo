...
project_1_ranking_1.store = {
				...
				'ablation_forward': '/data/sls/qcri/mt/work/NeuroDissection/test_data/ablation_results/en-es/Model-2-3-Cross-Model-Ranking.txt',
				'ablation_backward': '/data/sls/qcri/mt/work/NeuroDissection/test_data/ablation_results/en-es/Model-2-3-Cross-Model-Ranking-Reverse.txt'
			}
...
project_1_ranking_2.store = {
				...
				'ablation_forward': '/data/sls/qcri/mt/work/NeuroDissection/test_data/ablation_results/en-es/Part-of-Speech-Ranking.txt',
				'ablation_backward': '/data/sls/qcri/mt/work/NeuroDissection/test_data/ablation_results/en-es/Part-of-Speech-Ranking-Reverse.txt'
			}
...
project_1_ranking_3.store = {
				...
				'ablation_forward': '/data/sls/qcri/mt/work/NeuroDissection/test_data/ablation_results/en-es/Part-of-Speech-Univariate-Feature-Selection.txt',
				'ablation_backward': '/data/sls/qcri/mt/work/NeuroDissection/test_data/ablation_results/en-es/Part-of-Speech-Univariate-Feature-Selection-Reverse.txt'
			}
...
project_1_ranking_4.store = {
				...
				'ablation_forward': '/data/sls/qcri/mt/work/NeuroDissection/test_data/ablation_results/en-es/Semantic-Tags-Ranking.txt',
				'ablation_backward': '/data/sls/qcri/mt/work/NeuroDissection/test_data/ablation_results/en-es/Semantic-Tags-Ranking-Reverse.txt'
			}
...
project_2_ranking_1.store = {
					...
					'ablation_forward': '/data/sls/qcri/mt/work/NeuroDissection/test_data/ablation_results/en-ar/Model-2-3-Cross-Model-Ranking.txt',
					'ablation_backward': '/data/sls/qcri/mt/work/NeuroDissection/test_data/ablation_results/en-ar/Model-2-3-Cross-Model-Ranking-Reverse.txt'
				}
...
project_2_ranking_2.store = {
					...
					'ablation_forward': '/data/sls/qcri/mt/work/NeuroDissection/test_data/ablation_results/en-ar/Part-of-Speech-Ranking.txt',
					'ablation_backward': '/data/sls/qcri/mt/work/NeuroDissection/test_data/ablation_results/en-ar/Part-of-Speech-Ranking-Reverse.txt'
				}
...
project_2_ranking_3.store = {
					...
					'ablation_forward': '/data/sls/qcri/mt/work/NeuroDissection/test_data/ablation_results/en-ar/Part-of-Speech-Univariate-Feature-Selection.txt',
					'ablation_backward': '/data/sls/qcri/mt/work/NeuroDissection/test_data/ablation_results/en-ar/Part-of-Speech-Univariate-Feature-Selection-Reverse.txt'
				}
...
project_2_ranking_4.store =  {
					...
					'ablation_forward': '/data/sls/qcri/mt/work/NeuroDissection/test_data/ablation_results/en-ar/Semantic-Tags-Ranking.txt',
					'ablation_backward': '/data/sls/qcri/mt/work/NeuroDissection/test_data/ablation_results/en-ar/Semantic-Tags-Ranking-Reverse.txt'
				}
